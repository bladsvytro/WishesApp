...
// Load keystore properties from local keystore.properties (not committed to git)
...
android {
    namespace = "com.wishesapp"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.wishesapp"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // DataStore (widget mode preference)
